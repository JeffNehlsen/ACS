...
skills = {
  -- General
  vision = skillranks.inept,
  avoidance = skillranks.inept,
  survival = skillranks.apprentice,
  weaponry = skillranks.capable,
  tattoos = skillranks.inept,
  
  dhuriv = skillranks.transcendant,
  woodlore = skillranks.gifted,
}
